...
public class BookingCar
{
  ...
  public BookingCar(int bookingNr, String status, String startDate,
      String startTime, String endDate, String endTime, String price,
      int greenShare, int carId, int customerId)
  {
