...
public class Databasehelper
{
  ...
  public boolean addUser(User user) {
    String query = "INSERT INTO user (userFirstname, userLastname, title, email, phonenr, username, password, userpermission) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try (Connection connection = getConnection();
      ...
      if (resultSet.next()) {
        return new User(
            ...
            resultSet.getString("userpermission")
        );
      }
  ...
  public boolean addCustomer(Customer customer) {
    String query = "INSERT INTO customer (first_name, last_name, username, password, email, phonenr) VALUES (?, ?, ?, ?, ?, ?)";
    try (Connection connection = getConnection();
        PreparedStatement statement = connection.prepareStatement(query)) {
